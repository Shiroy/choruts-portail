...
public function p($string, $toBr = 0, $justParse = 1, $useSmilies = 1, $simpleSmilies = 1, $protectMails = 1, $showFormattedTwice = 0, $onShutdown = "") {
...
public function showSmileys() {
	...
	// access parent function and gather encoded smiley code

	$this->smilies($_GET['smiley']);
